...
export class PetApi extends runtime.BaseAPI {
     ...
     * Add a new pet to the store
     */
    async addPet(pet: Pet, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Pet> {
        const response = await this.addPetRaw({ pet: pet }, initOverrides);
     ...
     * Finds Pets by status
     */
    async findPetsByStatus(status?: FindPetsByStatusStatusEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Pet>> {
     ...
     * Update an existing pet
     */
    async updatePet(pet: Pet, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Pet> {
        const response = await this.updatePetRaw({ pet: pet }, initOverrides);
        return await response.value();
    }
     ...
     * uploads an image
     */
    async uploadFile(petId: number, additionalMetadata?: string, body?: Blob, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ModelApiResponse> {
        const response = await this.uploadFileRaw({ petId: petId, additionalMetadata: additionalMetadata, body: body }, initOverrides);
        return await response.value();
    }
