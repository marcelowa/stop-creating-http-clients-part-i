...
export class UserApi extends runtime.BaseAPI {
     ...
     * Create user
     */
    async createUser(user?: User, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<User> {
        const response = await this.createUserRaw({ user: user }, initOverrides);
     ...
     * Creates list of users with given input array
     */
    async createUsersWithListInput(user?: Array<User>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<User> {
        const response = await this.createUsersWithListInputRaw({ user: user }, initOverrides);
        return await response.value();
    }
     ...
     * Update user
     */
    async updateUser(username: string, user?: User, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.updateUserRaw({ username: username, user: user }, initOverrides);
    }
