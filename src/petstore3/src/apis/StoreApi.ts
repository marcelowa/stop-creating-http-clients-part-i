...
export class StoreApi extends runtime.BaseAPI {
     ...
     * Delete purchase order by ID
     */
    async deleteOrder(orderId: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
     ...
     * Place an order for a pet
     */
    async placeOrder(order?: Order, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Order> {
        const response = await this.placeOrderRaw({ order: order }, initOverrides);
        return await response.value();
    }
